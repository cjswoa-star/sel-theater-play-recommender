...
(function () {
  ...
  const recommendationOverrides = {
    ...
    '099': {
      purposes: ['의사소통', '듣기', '비언어 소통']
    },
    '100': {
      purposes: ['듣기', '리듬 맞추기', '집중하기']
    },
    '102': {
      purposes: ['비언어 소통', '듣기', '의사소통']
    },
    '103': {
      purposes: ['듣기', '목소리 열기', '비언어 소통']
    },
    '104': {
      purposes: ['듣기', '집중하기', '기억'],
      sel: ['자기 조절']
    ...
    '120': {
      purposes: ['듣기', '협력하기', '비언어 소통'],
      sel: ['사회적 인식', '관계 기술']
    },
    '121': {
      purposes: ['듣기', '목소리 열기', '협력하기']
    },
    '122': {
      purposes: ['듣기', '비언어 소통', '협력하기']
    },
    '128': {
    ...
    '129': {
      purposes: ['듣기', '상상 열기', '협력하기']
    },
    '130': {
      purposes: ['듣기', '집중하기', '상상 열기']
    }
  };
